...
const StaffTicketsPage = () => {
    ...
    const fetchPending = async  ()=>{
        const response = await  axios.get(
            `http://34.171.165.241:4000/api/ticket/countPending/${userInfo[0].id_usuario}`
        );
    ...
    const fetchTotalTickets= async  ()=>{
        const response = await  axios.get(
            "http://34.171.165.241:4000/api/ticket/countTotal"
        );
    ...
    const fetchTicket =async  ()=>{
        const response = await  axios.get(
            `http://34.171.165.241:4000/api/ticket/assigned/${userInfo[0].id_usuario}`
        );
