...
const ManagementAllocationPage = () => {
    ...
    const fetchUnassignedTickets = async  ()=>{
        const response = await  axios.get(
            "http://34.171.165.241:4000/api/ticket/countUnassigned"
        );
    ...
    const fetchStaff = async  ()=>{
        const response = await  axios.get(
            "http://34.171.165.241:4000/api/ticket/countEmpleados"
        );
    ...
    const fetchCoordinatorTickets = async  ()=>{
        const response = await  axios.get(
            "http://34.171.165.241:4000/api/ticket/getCoordinatorTickets"
        );
