...
const ManagementUserPage = () => {
    ...
    const fetchUsers = async () =>{
        const response = await axios.get(
            "http://34.171.165.241:4000/api/admin/"
        );
    ...
    const fetchNumUsers = async () =>{
        const response = await axios.get(
            "http://34.171.165.241:4000/api/admin/countUsers"
        );
    ...
    const fetchProviders = async () =>{
        const response = await axios.get(
            "http://34.171.165.241:4000/api/admin/countProvider"
        );
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await axios.put(
            "http://34.171.165.241:4000/api/admin/update",
            {
    ...
    const handleDelete = async (key, estado) =>{
        ...
        if(estado === 'I') {
            console.log("Entra")
            try {
                const { data } = await axios.put("http://34.171.165.241:4000/api/admin/activate", {
                    key
                });
            ...
            console.log("Es A")
                try {
                    const { data } = await axios.put("http://34.171.165.241:4000/api/admin/delete", {
                        key
                    });
